...
const volleyballData = [
  { id: '1', team: '@Nebraska', price: '$40' },
  { id: '2', team: '@Wisconsin', price: '$45' },
  { id: '3', team: '@Purdue', price: '$35' },
  { id: '4', team: '@Michigan', price: '$50' },
];
...
const VolleyballScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Sub-header */}
      <Text style={styles.subTitle}>Women's Volleyball</Text>
      ...
      <View style={styles.bottomNavigation}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Sports')}>
          <Icon name="volleyball" size={24} color="#000" /> {/* Volleyball icon */}
        </TouchableOpacity>
        <TouchableOpacity
