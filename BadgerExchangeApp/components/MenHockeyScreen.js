...
const data = [
  { id: '1', team: '@Minnesota', price: '$60' },
  { id: '2', team: '@Michigan', price: '$60' },
  { id: '3', team: '@Ohio State', price: '$60' },
  { id: '4', team: '@Penn State', price: '$60' },
];

const MenHockeyScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Sub-header */}
      <Text style={styles.subTitle}>Men's Hockey</Text>
...
export default MenHockeyScreen;
