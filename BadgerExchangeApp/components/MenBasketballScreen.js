...
const data = [
  { id: '1', team: '@Indiana', price: '$45' },
  { id: '2', team: '@Michigan State', price: '$50' },
  { id: '3', team: '@Illinois', price: '$55' },
  { id: '4', team: '@Purdue', price: '$60' },
];

const MenBasketballScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Sub-header */}
      <Text style={styles.subTitle}>Men's Basketball</Text>
...
export default MenBasketballScreen;
