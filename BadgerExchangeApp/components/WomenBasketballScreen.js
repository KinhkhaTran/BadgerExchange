...
const basketballData = [
  { id: '1', team: '@Iowa', price: '$45' },
  { id: '2', team: '@Maryland', price: '$50' },
  { id: '3', team: '@Indiana', price: '$40' },
  { id: '4', team: '@Michigan State', price: '$35' },
];

const WomenBasketballScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Sub-header */}
      <Text style={styles.subTitle}>Women's Basketball</Text>
      ...
      <View style={styles.bottomNavigation}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Sports')}>
          <Icon name="basketball" size={24} color="#000" />
        </TouchableOpacity>
        <TouchableOpacity
...
export default WomenBasketballScreen;
